...
i = 6; % Coherence is the second column of the data
j = 6; % Coherence is the fourth column of the data
x_lim = [0 20];
y_lim = [0 1];
x_ticks = [0 10 20];
y_ticks = [0 0.5 1];
...
title(titles{2}, 'FontSize', title_fontsize,'FontWeight',title_fontWeight,'FontName',title_fontName);
...
lgd.Position = [0.26 0.55 0.2363 0.3039];
%% marking figures
text(ax1, 0.82, 0.13, '(a)', 'Units','normalized','FontSize',marker_fontsize,'FontWeight',marker_fontweight,'FontName',marker_fontname)
text(ax2, 0.725, 0.13, '(b)', 'Units','normalized','FontSize',marker_fontsize,'FontWeight',marker_fontweight,'FontName',marker_fontname)

%% Save and export figurs
if ~exist('ghafar_plots', 'dir')
    mkdir('ghafar_plots');
end
fname = 'ghafar_plots\Fig14-v2';
