...
pbg_phi_0_path = strcat(pbg_directory, 'omega-is-0.500000\phi-is-0\sampled_measurements.csv');
pbg_phi_pi_2_path = strcat(pbg_directory, 'omega-is-0.500000\phi-is-pi-over-2\sampled_measurements.csv');
pbg_phi_pi_path = strcat(pbg_directory, 'omega-is-0.500000\phi-is-pi\sampled_measurements.csv');
vac_phi_0_path = strcat(vac_directory, 'omega-is-0.500000\phi-is-0\sampled_measurements.csv');
vac_phi_pi_2_path = strcat(vac_directory, 'omega-is-0.500000\phi-is-pi-over-2\sampled_measurements.csv');
vac_phi_pi_path = strcat(vac_directory, 'omega-is-0.500000\phi-is-pi\sampled_measurements.csv');
...
%% add legend
lgd = legend(ax1, [p1, p2, p3],{'$\phi=0$', '$\phi=\pi/2$', '$\phi=\pi$'}, 'Location', 'northeast', FontSize=legend_fontsize, Interpreter='latex', Box="off");
lgd.ItemTokenSize = [20 6];
lgd.Position = [0.2727 0.5571 0.2363 0.3039];
